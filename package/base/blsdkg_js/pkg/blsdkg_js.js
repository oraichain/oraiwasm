...
*/
module.exports.sign = function(sk, msg) {
    var ret = wasm.sign(addHeapObject(sk), addHeapObject(msg));
...
*/
module.exports.get_sk_share = function(rows, commits) {
    var ptr0 = passArrayJsValueToWasm0(rows, wasm.__wbindgen_malloc);
    var len0 = WASM_VECTOR_LEN;
    var ptr1 = passArrayJsValueToWasm0(commits, wasm.__wbindgen_malloc);
    var len1 = WASM_VECTOR_LEN;
    var ret = wasm.get_sk_share(ptr0, len0, ptr1, len1);
    return ret === 0 ? undefined : KeyShare.__wrap(ret);
};
...
* @returns {Share}
*/
module.exports.generate_bivars = function(threshold, total_nodes) {
    var ret = wasm.generate_bivars(threshold, total_nodes);
...
class KeyShare {
    ...
    */
    get_pk() {
        var ret = wasm.keyshare_get_pk(this.ptr);
        return takeObject(ret);
    }
    /**
    ...
    */
    sign_g2(input, round) {
        uint64CvtShim[0] = round;
        const low0 = u32CvtShim[0];
        const high0 = u32CvtShim[1];
        var ret = wasm.keyshare_sign_g2(this.ptr, addHeapObject(input), low0, high0);
        return takeObject(ret);
    }
}
...
class Share {
    ...
    */
    get_commits() {
        try {
            ...
            wasm.share_get_commits(retptr, this.ptr);
    ...
    */
    get_rows() {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.share_get_rows(retptr, this.ptr);
            var r0 = getInt32Memory0()[retptr / 4 + 0];
            var r1 = getInt32Memory0()[retptr / 4 + 1];
            var v0 = getArrayJsValueFromWasm0(r0, r1).slice();
            wasm.__wbindgen_free(r0, r1 * 4);
...
const path = require('path').join(__dirname, 'blsdkg_js_bg.wasm');

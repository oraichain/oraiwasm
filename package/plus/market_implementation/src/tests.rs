...
use market_auction::{AuctionQueryMsg, AuctionsResponse, PagingOptions, QueryAuctionsResult};
use market_royalty::{
...
fn sell_auction_happy_path() {
    unsafe {
        ...
        //manager.deps.querier.wasm_handler();
        ...
        println!("error {:?}", _ret_error);

        let result: AuctionsResponse = from_binary(
            &manager
                .query(QueryMsg::Auction(

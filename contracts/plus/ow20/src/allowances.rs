...
pub fn handle_transfer_from(
    ...
    let spender_raw = deps.api.addr_canonicalize(&info.sender.as_str())?;
...
mod tests {
    ...
    use cosmwasm_std::{coins, CosmosMsg, StdError, Timestamp, WasmMsg};
